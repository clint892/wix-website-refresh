      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <a href="tel:+254715656204" className="flex items-center gap-1.5 text-sm font-medium">
        ...
        {isOpen && (
          <div className="lg:hidden pb-4 border-t border-primary-foreground/20">
            ...
            <div className="px-4 pt-3 flex flex-col gap-2">
              <a href="tel:+254715656204" className="flex items-center justify-center gap-2 py-2.5 border border-primary-foreground/30 rounded-md">
