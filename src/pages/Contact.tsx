...
const Contact = () => {
  return (
    <Layout>
      <SEO title="Contact Us" description="Get in touch with Sync Insurance Agency. Call +254 706 893 451 or visit us at Jubilee Exchange Building, Nairobi." canonical="/contact" />
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              {[
                { icon: Phone, title: "Phone", lines: ["+254 706 893 451"]  },
